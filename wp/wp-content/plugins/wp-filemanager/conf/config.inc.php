...
if (get_option('wp_fileman_Allow_Download') == 'checked')
	$AllowDownload        = TRUE;
else
	$AllowDownload        = FALSE;

if (get_option('wp_fileman_Create_File') == 'checked')
	$AllowCreateFile        = TRUE;
else
	$AllowCreateFile        = FALSE;

if (get_option('wp_fileman_Create_Folder') == 'checked')
	$AllowCreateFolder        = TRUE;
else
	$AllowCreateFolder        = FALSE;
	
if (get_option('wp_fileman_Allow_Rename') == 'checked')
	$AllowRename        = TRUE;
else
	$AllowRename        = FALSE;
if (get_option('wp_fileman_Allow_Upload') == 'checked')
	$AllowUpload        = TRUE;
else
	$AllowUpload        = FALSE;
if (get_option('wp_fileman_Allow_Delete') == 'checked')
	$AllowDelete        = TRUE;
else
	$AllowDelete        = FALSE;
if (get_option('wp_fileman_Allow_View') == 'checked')
	$AllowView        = TRUE;
else
	$AllowView        = FALSE;
if (get_option('wp_fileman_Allow_Edit') == 'checked')
	$AllowEdit        = TRUE;
else
	$AllowEdit        = FALSE;
if (get_option('wp_fileman_Show_Exteension') == 'checked')
	$ShowExtension        = TRUE;
else
	$ShowExtension        = FALSE;
...
if (trim(get_option('wp_fileman_editable_ext')) != "")
{
