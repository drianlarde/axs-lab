...
// define('SIL_RSS_URL', get_bloginfo('wpurl') . '/wp-content//sil_rss_reader/');
define('SIL_RSS_URL', get_bloginfo('wpurl') . '/wp-content//'.basename(dirname(__FILE__)).'/');
...
function sil_rss_install() {
	...
	if(!sil_rss_table_exists($sil_rss_table_name)) {
		...
		$feed_link = "http://.org/development/";
		$feed_url = "http://.org/development/feed/";
...
add_action('_loaded', 'sil_rss_start');
...
<!--  OPML generated by sil_rss plugin for  -->
<opml version="1.1">
	<head>
...
function sil_rss_init() {
	...
	// load_plugin_textdomain('sil_rss', 'wp-content//sil_rss_reader/lang');
	load_plugin_textdomain('sil_rss', 'wp-content//'.basename(dirname(__FILE__)).'/lang');
}
