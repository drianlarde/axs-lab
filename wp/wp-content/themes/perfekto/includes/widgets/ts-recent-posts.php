  ...
  /** @see WP_Widget::widget */
              ...
              <?php echo $before_widget; ?>
                  <?php if ( $title )
                        echo $before_title . $title . $after_title; ?>
								...
								<?php } ?>
								<span class="t1"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to', 'templatesquare');?> <?php the_title_attribute(); ?>"><?php the_title();?></a></span><br />
    ...
    function form($instance) {
        ...
        ?>
            ...
            <p><label for="<?php echo $this->get_field_id('showpost'); ?>"><?php _e('Show Post:', 'templatesquare'); ?> <input class="widefat" id="<?php echo $this->get_field_id('showpost'); ?>" name="<?php echo $this->get_field_name('showpost'); ?>" type="text" value="<?php echo $showpost; ?>" /></label></p>
			
            <p><label for="<?php echo $this->get_field_id('showdate'); ?>"><?php _e('Show Date:', 'templatesquare'); ?> 
