...
<div id="blog">
	<div class="container">
		<div class="sixteen columns">
			<h1><?php
			if ( is_day() ) :
				printf( __( 'Daily Archives: %s', $textdoimain ), get_the_date() );

			elseif ( is_month() ) :
				printf( __( 'Monthly Archives: %s', $textdoimain ), get_the_date( _x( 'F Y', 'monthly archives date format', $textdoimain ) ) );

			elseif ( is_year() ) :
				printf( __( 'Yearly Archives: %s', $textdoimain ), get_the_date( _x( 'Y', 'yearly archives date format', $textdoimain ) ) );

			else :
				_e( 'Archives', $textdoimain );
