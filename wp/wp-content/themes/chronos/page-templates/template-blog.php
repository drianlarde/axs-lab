...
<div id="blog">
    <div class="container">
        <div class="sixteen columns">
            <h1><span><?php echo esc_attr($theme_option['blog_title']); ?></span></h1>
            <div class="head-subtext"><?php echo esc_attr($theme_option['blog_subtitle']); ?></div>
        </div>
    </div>
    <div class="clear"></div>
    <div class="container">
        ...
        <div class="four columns" data-scrollreveal="enter right and move 150px over 1s">
